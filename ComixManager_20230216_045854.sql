...
CREATE TABLE `Oggetti`( 
	...
	CONSTRAINT `unique_articoli_dipendenti_negozi_oggetti` UNIQUE( `idArticolo`, `idOggetto`, `idDipendente`, `iNegozio` ),
...
CREATE INDEX `unique_email` USING BTREE ON `Fornitori`( `eMail` );-- -------------------------------------------------------------;


-- CREATE INDEX "unique_entita" --------------------------------
CREATE INDEX `unique_entita` USING BTREE ON `Fornitori`( `Nome`, `Citta`, `Indirizzo` );-- -------------------------------------------------------------;


-- CREATE INDEX "unique_fax" -----------------------------------
CREATE INDEX `unique_fax` USING BTREE ON `Fornitori`( `Fax` );-- -------------------------------------------------------------;
